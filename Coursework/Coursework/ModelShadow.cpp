...
ModelShadow::ModelShadow(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd)
{
	initShader(L"modelShadow_vs.cso", L"modelShadow_ps.cso");
}
...
void ModelShadow::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView* depthMap, Light* PointLight1, Light* PointLight2, Light* directionalLight)
{
...
void ModelShadow::initShader(const wchar_t* vs, const wchar_t* ps)
{
